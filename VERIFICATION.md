...
- JavaScript syntax check passed. Design detector ran in degraded regex mode; its advisory heading-size and icon-radius findings are intentional and documented in DESIGN.md. The download page uses existing solid-surface color pairs and the existing icon.
